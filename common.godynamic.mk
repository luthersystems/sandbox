...
BUILD_IMAGE=${BUILD_IMAGE_GODYNAMIC}
...
${STATIC_IMAGE_DUMMY}: ${GO_SOURCE_FILES} Makefile ${PROJECT_REL_DIR}/common.mk ${PROJECT_REL_DIR}/go.mod ${PROJECT_REL_DIR}/common.godynamic.mk
	${MKDIR_P} $(dir $@)
	${TIME_P} ${DOCKER_RUN} \
