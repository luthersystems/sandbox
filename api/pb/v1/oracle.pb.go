...
const (
	...
	ClaimState_CLAIM_STATE_LOECLAIM_COLLECTED_DETAILS ClaimState = 1
	ClaimState_CLAIM_STATE_LOECLAIM_ID_VERIFIED       ClaimState = 2
	ClaimState_CLAIM_STATE_OOECLAIM_REVIEWED          ClaimState = 3
	ClaimState_CLAIM_STATE_OOECLAIM_VALIDATED         ClaimState = 4
	ClaimState_CLAIM_STATE_LOEFIN_INVOICE_ISSUED      ClaimState = 5
	ClaimState_CLAIM_STATE_OOEFIN_INVOICE_REVIEWED    ClaimState = 6
	ClaimState_CLAIM_STATE_OOEFIN_INVOICE_APPROVED    ClaimState = 7
	ClaimState_CLAIM_STATE_OOEPAY_PAYMENT_TRIGGERED   ClaimState = 8
)
...
var (
	ClaimState_name = map[int32]string{
		...
		3: "CLAIM_STATE_OOECLAIM_REVIEWED",
		4: "CLAIM_STATE_OOECLAIM_VALIDATED",
		5: "CLAIM_STATE_LOEFIN_INVOICE_ISSUED",
		6: "CLAIM_STATE_OOEFIN_INVOICE_REVIEWED",
		7: "CLAIM_STATE_OOEFIN_INVOICE_APPROVED",
		8: "CLAIM_STATE_OOEPAY_PAYMENT_TRIGGERED",
	}
...
var file_pb_v1_oracle_proto_rawDesc = []byte{
	...
	0x22, 0x49, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x52,
	...
	0x52, 0x09, 0x65, 0x78, 0x63, 0x65, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x2c, 0x0a, 0x0f, 0x47,
	0x65, 0x74, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19,
	0x0a, 0x08, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x49, 0x64, 0x22, 0x6a, 0x0a, 0x10, 0x47, 0x65, 0x74,
	0x43, 0x6c, 0x61, 0x69, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a,
	...
	,
	...
	0x45, 0x43, 0x4c, 0x41, 0x49, 0x4d, 0x5f, 0x43, 0x4f, 0x4c, 0x4c, 0x45, 0x43, 0x54, 0x45, 0x44,
	0x5f, 0x44, 0x45, 0x54, 0x41, 0x49, 0x4c, 0x53, 0x10, 0x01, 0x12, 0x24, 0x0a, 0x20, 0x43, 0x4c,
	0x41, 0x49, 0x4d, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x4c, 0x4f, 0x45, 0x43, 0x4c, 0x41,
	0x49, 0x4d, 0x5f, 0x49, 0x44, 0x5f, 0x56, 0x45, 0x52, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x02,
	...
	0x44, 0x10, 0x03, 0x12, 0x22, 0x0a, 0x1e, 0x43, 0x4c, 0x41, 0x49, 0x4d, 0x5f, 0x53, 0x54, 0x41,
	0x54, 0x45, 0x5f, 0x4f, 0x4f, 0x45, 0x43, 0x4c, 0x41, 0x49, 0x4d, 0x5f, 0x56, 0x41, 0x4c, 0x49,
	0x44, 0x41, 0x54, 0x45, 0x44, 0x10, 0x04, 0x12, 0x25, 0x0a, 0x21, 0x43, 0x4c, 0x41, 0x49, 0x4d,
	0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x4c, 0x4f, 0x45, 0x46, 0x49, 0x4e, 0x5f, 0x49, 0x4e,
	0x56, 0x4f, 0x49, 0x43, 0x45, 0x5f, 0x49, 0x53, 0x53, 0x55, 0x45, 0x44, 0x10, 0x05, 0x12, 0x27,
	...
	0x49, 0x45, 0x57, 0x45, 0x44, 0x10, 0x06, 0x12, 0x27, 0x0a, 0x23, 0x43, 0x4c, 0x41, 0x49, 0x4d,
	0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x4f, 0x4f, 0x45, 0x46, 0x49, 0x4e, 0x5f, 0x49, 0x4e,
	0x56, 0x4f, 0x49, 0x43, 0x45, 0x5f, 0x41, 0x50, 0x50, 0x52, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x07,
	...
	0x52, 0x49, 0x47, 0x47, 0x45, 0x52, 0x45, 0x44, 0x10, 0x08, 0x42, 0x79, 0x0a, 0x09, 0x63, 0x6f,
...
var file_pb_v1_oracle_proto_depIdxs = []int32{
	...
	6, // 2: pb.v1.GetClaimResponse.exception:type_name -> common.v1.Exception
	5, // 3: pb.v1.GetClaimResponse.claim:type_name -> pb.v1.Claim
	0, // 4: pb.v1.Claim.state:type_name -> pb.v1.ClaimState
