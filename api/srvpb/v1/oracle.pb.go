...
var file_srvpb_v1_oracle_proto_goTypes = []any{
	...
	(*v11.UploadInvoiceRequest)(nil),   // 4: pb.v1.UploadInvoiceRequest
	(*v11.ProcessInvoiceRequest)(nil),  // 5: pb.v1.ProcessInvoiceRequest
	(*v1.GetHealthCheckResponse)(nil),  // 6: healthcheck.v1.GetHealthCheckResponse
	(*v11.CreateClaimResponse)(nil),    // 7: pb.v1.CreateClaimResponse
	(*v11.AddClaimantResponse)(nil),    // 8: pb.v1.AddClaimantResponse
	(*v11.GetClaimResponse)(nil),       // 9: pb.v1.GetClaimResponse
	(*v11.UploadInvoiceResponse)(nil),  // 10: pb.v1.UploadInvoiceResponse
	(*v11.ProcessInvoiceResponse)(nil), // 11: pb.v1.ProcessInvoiceResponse
}
var file_srvpb_v1_oracle_proto_depIdxs = []int32{
	...
	4,  // 4: srvpb.v1.SandboxService.UploadInvoice:input_type -> pb.v1.UploadInvoiceRequest
	5,  // 5: srvpb.v1.SandboxService.ProcessInvoice:input_type -> pb.v1.ProcessInvoiceRequest
	6,  // 6: srvpb.v1.SandboxService.GetHealthCheck:output_type -> healthcheck.v1.GetHealthCheckResponse
	7,  // 7: srvpb.v1.SandboxService.CreateClaim:output_type -> pb.v1.CreateClaimResponse
	8,  // 8: srvpb.v1.SandboxService.AddClaimant:output_type -> pb.v1.AddClaimantResponse
	9,  // 9: srvpb.v1.SandboxService.GetClaim:output_type -> pb.v1.GetClaimResponse
	10, // 10: srvpb.v1.SandboxService.UploadInvoice:output_type -> pb.v1.UploadInvoiceResponse
	11, // 11: srvpb.v1.SandboxService.ProcessInvoice:output_type -> pb.v1.ProcessInvoiceResponse
